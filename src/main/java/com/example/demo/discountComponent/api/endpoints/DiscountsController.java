...
public class DiscountsController {
    ...
    public ResponseEntity<Object> createDiscount (@RequestParam UUID employeeId, @RequestBody PostDiscountDTO postDiscountDTO){
        ...
        DiscountDTO createdDiscount = discountService.createDiscount(postDiscountDTO);
    ...
    public  ResponseEntity<Object> updateDiscount(@PathVariable UUID discountId, @RequestParam UUID  employeeId,
        ...
        ResponseDiscountDTO updatedDiscount = discountService.updateDiscount(employeeId, patchDiscountDTO);
    ...
    public ResponseEntity<Object> deleteDiscount(@PathVariable UUID discountId, @RequestParam UUID employeeId){
        ...
        boolean wasDeletionSuccessful = discountService.deleteDiscount(discountId);

        ValidationForDifferentHTTPCodes.checkFor404(wasDeletionSuccessful); //cringe, right now need to get null from wasDeletionSuccessful
