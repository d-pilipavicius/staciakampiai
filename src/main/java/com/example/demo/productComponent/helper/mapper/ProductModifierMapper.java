...
public class ProductModifierMapper {
        ...
        public static final StaticMapper<ProductModifier, ProductModifierDTO> TO_DTO = entity -> ProductModifierDTO
                        .builder()
                        .id(entity.getId())
        ...
        public static final StaticMapper<Page<ProductModifierDTO>, GetModifiersDTO> PAGE_TO_GET_MODIFIERS_DTO = productModifierDTO -> GetModifiersDTO
                        .builder()
        ...
        public static final StaticMapper<List<ProductModifierDTO>, GetModifiersDTO> LIST_TO_GET_MODIFIERS_DTO = productModifierDTO -> GetModifiersDTO
                        .builder()
